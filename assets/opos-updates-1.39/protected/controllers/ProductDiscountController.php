...
class ProductDiscountController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ProductDiscount'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		$model=new ProductDiscount('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProductDiscount']))
			$model->attributes=$_GET['ProductDiscount'];
		$model->product_id = $product_id;
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='product-discount-form')
		{
	...
	public function actionEnable()
	{
		...
		if(isset($_POST['ids'])){
			foreach ($_POST['ids'] as $key => $value) {
				...
				//jika enable , maka updtae menjadi disable
				if($model->enable == 1){
					$model->enable = 0;
				}else{
					$model->enable = 1;
