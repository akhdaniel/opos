        ...
        <div class="row-fluid pad">
            ...
            <div class="span6">
                <div class="numeric-keypad keypad">
                    <div class="row-fluid">
                        <button class="btn span3" data-value="1" onclick="numericTouch('1');">1</button>
                        <button class="btn span3" data-value="2" onclick="numericTouch('2');">2</button>
                        <button class="btn span3" data-value="3" onclick="numericTouch('3');">3</button>
                        <button class="btn span3 btn-success" data-value="qty" id="qty_button" >Qty</button>
                    </div>
                    <div class="row-fluid">
                        <button class="btn span3" data-value="4" onclick="numericTouch('4');">4</button>
                        <button class="btn span3" data-value="5" onclick="numericTouch('5');">5</button>
                        <button class="btn span3" data-value="6" onclick="numericTouch('6');">6</button>
                    </div>
                    <div class="row-fluid">
                        <button class="btn span3" data-value="7" onclick="numericTouch('7');">7</button>
                        <button class="btn span3" data-value="8" onclick="numericTouch('8');">8</button>
                        <button class="btn span3" data-value="9" onclick="numericTouch('9');">9</button>
                    </div>
                    <div class="row-fluid">
                        <button class="btn span3" data-value="pm">+/-</button>
                        <button class="btn span3" data-value="0" onclick="numericTouch('0');">0</button>
                        <button class="btn span3" data-value=".">.</button>
                        <button class="btn span3 btn-primary" data-value="qty" id="notes_button" >Notes</button>
                    </div>
                    <div class="row-fluid">
                        <button class="btn btn-danger span4" data-value="backspace" id="deleteBtn">Delete</button>
                        <button class="btn btn-primary span4" data-value="delivered" id="deliverBtn">Deliver All</button>
                        <button class="btn btn-success span4" data-value="ok" id="okBtn">Ok</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="bootstrap-widget span12">
                ...
                <div class="bootstrap-widget-content">
                   <div class="row-fluid">
                        <ul class="thumbnails">
                           <li class="span4" onclick="filterProduct('1')">
                                <div class="thumbnail">
                           ...
                           <li class="span4" onclick="filterProduct('2')">
                                <div class="thumbnail">
                                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/default.png"/>
                                    <div class="caption">
                           ...
                           <li class="span4" onclick="filterProduct('3')">
                                <div class="thumbnail">
                                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/default.png"/>
                                    <div class="caption">
